...
import { ArrowLeft, Car, Mail, Phone, Calendar, Ban, CheckCircle, ShoppingBag, Wrench, ChevronRight } from "lucide-react";
                      ...
                      <TableBody>
                        {bookings.map((booking) => (
                          <TableRow key={booking.id}>
                            ...
                            <TableCell>{booking.vehicleBrand} {booking.vehicleModel}</TableCell>
