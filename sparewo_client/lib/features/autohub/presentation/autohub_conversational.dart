...
class _AutoHubConversationalScreenState
  ...
  Widget build(BuildContext context) {
    // Watch the provider to rebuild this widget when state changes (e.g. typing)
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Your Saved Vehicles:", style: AppTextStyles.labelLarge),
                  ...
                  const SizedBox(height: 24),
                  Text("Or choose another:", style: AppTextStyles.labelLarge),
                  const SizedBox(height: 12),
  ...
  Widget _buildAddNewCarButton(BuildContext context) {
    return OutlinedButton.icon(
      ...
      label: const Text("Select Another Car"),
