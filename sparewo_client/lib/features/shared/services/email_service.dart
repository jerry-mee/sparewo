...
class EmailService {
  ...
  Future<bool> _sendEmail({
    ...
    if (_apiKey == null || _apiKey!.isEmpty) {
      print('Resend API Key is not configured. Email not sent.');
      return false;
    }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print('Email sent successfully to $recipients via Resend');
        return true;
      } else {
        print(
      ...
      print('HTTP error occurred while sending email via Resend: $e');
      return false;
    }
  }
